...
import {CreateUserDto, LoginUserDto, UpdatePasswordDto} from "./dto/users.dto";
...
//use by auth module to register user in database
    async create(userDto: CreateUserDto): Promise<any> {
        ...
        return await this.prisma.user.create({data:{name:userDto.name,login:userDto.login,surname:userDto.surname, password: await hash(userDto.password, 10),role:"CLIENT" as const
